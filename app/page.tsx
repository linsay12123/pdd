        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              solution: "解决：标准化生产流程，统一的引用核验报告提升专业度。激活码兑换模式方便团队分配额度，降低生产成本。"
            },
            {
              title: "学生个人",
      ...
      <section id="contact-sales" className="py-24 container mx-auto px-6 md:px-12">
        <div className="glass-panel rounded-3xl p-8 md:p-12 border-gold-glow relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
            <div>
              <h2 className="text-3xl font-serif font-bold mb-6">积分兑换规则</h2>
              <p className="text-brand-700 mb-8 leading-relaxed">拼代代采用“激活码兑换”模式，用户登录后输入激活码即可为账户增加积分。同一账号可多次兑换不同激活码，长期有效。</p>
